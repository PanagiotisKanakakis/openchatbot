...
# trainer.train("/mnt/c/Users/Panagiotis/ellak/questions.json")
...
print(response)
print(80 * "-")
response = chatbot.get_response('What about register to SELFIE?')
print(response)
print(80 * "-")
response = chatbot.get_response('What about register for SELFIE?')
print(response)
print(80 * "-")
response = chatbot.get_response('What about register for selfie?')
print(response)